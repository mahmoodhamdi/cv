...
PAGES: list[dict] = [
    ...
    {"slug": "stats",    "title": "Live GitHub stats",
     "subtitle": "Merged PRs, top contributions, and contribution activity — refreshed daily", "tag": "Stats"},
    {"slug": "changelog","title": "Site changelog",
     "subtitle": "Every change shipped to this portfolio, grouped by month", "tag": "Changelog"},
